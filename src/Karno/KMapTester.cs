...
namespace Karno
{
	public class KMapTester
	{
		...
		private static IEnumerable<string> CompileCoverage(Coverage coverage)
		{
		...
		/// </summary>
		private static bool TestInputOnMinterm(string input_string, string minterm_map)
		{
		...
		/// </summary>
		private static bool TestInputOnCoverage(string input_string, IEnumerable<string> compiled_coverage)
		{
